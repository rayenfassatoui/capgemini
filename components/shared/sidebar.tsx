      ...
      <div className={cn(
        ...
        <div className={cn("flex items-center gap-3 overflow-hidden transition-all duration-300", isCollapsed ? "w-0 opacity-0 hidden" : "w-auto opacity-100")}>
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-gray-500 dark:text-gray-400">Recruitment OS</p>
          </div>
        </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger>
                          ...
                          >
                            ...
                            {!isCollapsed && (
                              <span className="ml-3 flex-1 truncate">{t(item.labelKey)}</span>
                            )}
                            {!isCollapsed && (
              ...
              <Tooltip>
                <TooltipTrigger>
                  ...
                  >
                    ...
                    {!isCollapsed && <span className="ml-3">{theme === 'dark' ? t('settings.light') : t('settings.dark')}</span>}
                  </Button>
                </TooltipTrigger>
                {isCollapsed && <TooltipContent side="right">{theme === 'dark' ? t('settings.light') : t('settings.dark')}</TooltipContent>}
              </Tooltip>
            </TooltipProvider>
              ...
              <Tooltip>
                <TooltipTrigger>
                  ...
                  >
                    ...
                    {!isCollapsed && <span className="ml-3">{locale === 'en' ? 'Français' : 'English'}</span>}
                  </Button>
                </TooltipTrigger>
                 {isCollapsed && <TooltipContent side="right">{locale === 'en' ? 'Switch to French' : 'Switch to English'}</TooltipContent>}
              </Tooltip>
            </TooltipProvider>
