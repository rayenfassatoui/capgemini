...
Le layout de dashboard prépare déjà l'usage futur de l'IA à deux niveaux : un assistant flottant disponible dans les espaces métier et un workspace dédié \sourcecode{/agent} pour les analyses longues. L'entrée conversationnelle de la plateforme a donc été pensée dès le départ comme une fonctionnalité authentifiée, cloisonnée par rôle et intégrée à la navigation latérale.
...
Cette page joue aussi un rôle de clarification stratégique. Avant même la connexion, elle pose le positionnement du produit comme une plateforme de recrutement augmentée par l'IA et non comme un simple portail de candidatures, comme le montre la figure \ref{fig:landing-public}.

\begin{figure}[H]
  \centering
  \appcapture{figures/screenshots/landing_pages.png}
  \caption{\label{fig:landing-public}Page d'accueil publique de la plateforme.}
\end{figure}
...
Sur le plan UX, le formulaire reste volontairement direct. L'objectif est de réduire l'ambiguïté au moment de l'entrée dans la plateforme et de rendre visible le caractère administré de l'accès. La figure \ref{fig:sign-in-page} présente cette interface de connexion.
