...
\begin{figure}[H]
  \centering
  \appcapture{figures/screenshots/statistics-ai-chat.png}
  \caption{\label{fig:agent-workspace}Workspace agentique et réponse sourcée dans le chat.}
\end{figure}
