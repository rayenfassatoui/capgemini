...
\begin{itemize}
  ...
  \item l'émission de métadonnées de preuve : sources, blocs d'évidence, garde-fous de grounding et liens profonds vers les écrans métier.
\end{itemize}
Cette architecture est importante pour le rapport car elle montre que le chat n'est pas un composant isolé. Il est branché sur le cœur applicatif et réutilise les mêmes règles de sécurité, les mêmes services métier et les mêmes contraintes de traçabilité que le reste de la plateforme. L'interface finale réorganise ensuite la réponse en sections \textit{Observed from Sources}, \textit{Inferred / Recommended} et \textit{Source Limits}, puis affiche des puces de source cliquables et des liens profonds vers les CV, candidats, jobs ou surfaces d'audit.
