...
Sur le plan technique, les preuves automatisées principales sont documentées dans les artefacts du projet. Dans l'état observé, \sourcecode{bun run lint}, \sourcecode{bun run build} et \sourcecode{bun run test} passent ; la suite Vitest complète valide 123 tests après alignement du harnais \sourcecode{ChatInput} avec le contrat de propriétés du composant.
