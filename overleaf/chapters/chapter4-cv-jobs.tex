...
Cette interface montre que le vivier n'est pas une simple liste de fichiers. C'est une base de profils analysés, consultables et réexploitables, avec une lecture à la fois opérationnelle et analytique.
...
Ce point montre que ce module n'est pas isolé. Le détail d'une offre devient le point de convergence entre la demande de recrutement, la base documentaire des profils et les futurs mécanismes de décision.
