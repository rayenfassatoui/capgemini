...
C'est dans ce cadre que s'inscrit \projectname{}, une plateforme de recrutement orientée entreprise conçue pour centraliser les informations candidates, structurer les besoins de recrutement, coordonner les intervenants et rendre les décisions plus traçables. La solution couvre l'ensemble du cycle de recrutement : accès sécurisé, catalogue de CV, gestion des offres, assignation des candidats, historique des transitions, planification des entretiens, rapports d'évaluation, notifications, tableaux de bord, gouvernance et assistance intelligente.

L'originalité majeure de la solution réside dans l'intégration de l'intelligence artificielle comme aide au travail des recruteurs, et non comme remplacement de la décision humaine. L'assistance proposée sert à analyser les profils, préparer les entretiens, rechercher des informations dans les données disponibles, expliquer les résultats et demander une confirmation explicite avant toute action sensible. Cette orientation permet de conserver une maîtrise métier tout en améliorant la rapidité de traitement et la qualité de suivi.
...
\begin{itemize}
  ...
  \item le \textbf{chapitre 4} couvre la gestion du catalogue de CV et des offres d'emploi ;
