...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{3.2cm}X}
    ...
    Traçabilité & Logs d'activité, email logs, notifications, conversations et messages stockés en base. \\
    Fiabilité IA & Guardrails sur le nombre d'étapes agentiques, les tokens, le timeout et les échecs d'outils. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{1.2cm}p{3cm}p{3.2cm}X}
    ...
    PB4 & Pipeline candidat & Faire progresser un profil affecté dans un workflow multi-rôles traçable. & Affectation, états candidat, responsabilités TA/Manager/HR, planification, rapports d'entretien. \\
    PB5 & Intelligence IA & Assister les recruteurs par des analyses contextualisées et contrôlées. & Screening, matching hybride, guides d'entretien, autopilot, RAG, chat analytique outillé. \\
    PB6 & Gouvernance & Donner de la visibilité sur l'activité, les communications et l'onboarding. & Notifications, logs d'activité, logs emails, analytics, exports, suivi d'intégration. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{1.7cm}p{3.2cm}X}
    ...
    Sprint 3 & Pipeline et entretiens & Transformer une affectation CV-offre en suivi candidat complet, avec transitions d'état, responsabilités, planification et rapports. \\
    Sprint 4 & Intelligence IA & Ajouter une assistance IA réellement branchée sur les données internes : screening, recherche hybride, guides, autopilot et chat analytique. \\
    Sprint 5 & Gouvernance & Superviser le produit en exploitation : notifications, emails, activité, analytics, exports et onboarding. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\bfseries}p{3.1cm}p{3.1cm}X}
    ...
    Relier les profils aux besoins de recrutement & Offres, candidats et pipeline & Offres structurées, transitions d'état explicites et assignations multi-rôles. \\
    ...
    Interroger le système en langage naturel & Chat analytique & Agent conversationnel outillé, registre d'outils filtré par rôle et streaming SSE. \\
    Auditer et piloter l'activité & Gouvernance & Notifications, logs, analytics, exports et suivi détaillé de l'onboarding. \\
    \bottomrule
  \end{tabularx}
\end{table}
