...
La figure \ref{fig:landing-institutional} illustre ce positionnement institutionnel et l'entrée publique de la plateforme.

\begin{figure}[H]
  \centering
  \appcapture{figures/screenshots/landing_pages.png}
  \caption{\label{fig:landing-institutional}Page d'accueil institutionnelle de la plateforme.}
\end{figure}
