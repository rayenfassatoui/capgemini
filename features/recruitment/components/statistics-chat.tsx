      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 hidden w-105 max-w-[calc(100vw-3rem)] flex-col overflow-hidden rounded-2xl border border-white/8 backdrop-blur-xl bg-card/70 shadow-[0_8px_32px_rgba(0,0,0,0.4)] ring-1 ring-primary/10 xl:flex"
